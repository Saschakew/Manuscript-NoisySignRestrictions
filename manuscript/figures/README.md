...
| File | Source | Status |
|---|---|---|
| `fig_sign_dw_robust_noise_grid.png` | `../simulations/sign_dw_robust_noise_grid_figure.py` | M0017 corrected candidate: reproduces the KnowledgeVault 2-by-3 sign/DW noise grid with finite-sample N-test cutoffs and adds a robust-DW row. Preferred over the M0016 three-panel candidate for the user's requested visual. |
