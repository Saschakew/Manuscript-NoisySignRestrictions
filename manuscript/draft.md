...
Sign restrictions allow to set identify the impact of structural shocks. The identified set can be sharpened by combining sign restrictions with a non-Gaussian SVAR.
}
