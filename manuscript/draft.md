...
\comment{In the last part of the section, we should introduce an inversion of a J-Test instead of the rotation approach we used in the rest of the section. The difference is, that finding rotations always only 
