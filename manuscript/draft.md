...
representation is a convenient way to compute the same object: if \comment{just note that we are implicitly using the unit variance condition in this equation!
