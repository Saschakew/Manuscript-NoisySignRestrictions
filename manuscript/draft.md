...
\comment{lets clean up this paragraph. no mention of m49. just explain that dw measure dependency by third and fourth order co-moments and then introduce g_{DW,1}(B). we should also }
