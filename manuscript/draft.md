...
sign-admissible candidates whose estimated moment vector is small: \comment{this is not correct because you are missing the variance and covariance conditions from m_2! also mention efficient weighting, distribution of J, similar to what we write after the }
