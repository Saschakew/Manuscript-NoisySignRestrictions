...
Sign restrictions allow to set identify the impact of structural shocks. In a  non-Gaussian SVAR, the identified set can be sharpened by combining sign restrictions with 
}
