...
\comment{the section requires a simple proposition which states the conditions such that B_0 is no longer contained in the missspecified sign restricted svar}
