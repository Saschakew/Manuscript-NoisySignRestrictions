...
| `draft.md#4-robust-dw-higher-moment-set` | The robust DW set profiles diagonal residual-noise variances, keeps the off-diagonal residual covariance restriction, and uses higher cumulants of `B^{-1}u` written as GMM-style moment equations under the maintained diagonal Gaussian-noise condition. | our-contribution | `manuscript/derivations/dw-noise-robust-moments.md`; higher-moment GMM source | `paper2020GeneralizedMethodMomentsEstimator` |
...
| `draft.md#51-residual-noise-grid` | The M0035 bounded-noise residual grid is the current visual candidate: increasing Gaussian residual noise moves the sign/covariance set, can make standard DW reject true `B0`, and leaves bounded-noise robust DW truth-compatible after adding an explicit `0 <= nu_i <= 0.5` recovered-covariance screen. | our-contribution | `manuscript/simulations/sign_dw_robust_noise_grid_figure.py --robust-mode bounded`; `manuscript/simulations/sign_dw_bounded_noise_robust_grid_figure.md`; `manuscript/figures/fig_sign_dw_bounded_noise_robust_grid.png` | n/a |
