...
| `draft.md#5-monte-carlo-robustness-check` | Comparing standard DW and robust DW sets is an original diagnostic: overlap is reassuring, while divergence warns that usual DW precision may be noise-driven. | our-contribution | manuscript simulation design and derivation tasks | n/a |
