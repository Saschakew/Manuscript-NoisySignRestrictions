...
| `draft.md#51-residual-noise-grid` | The M0034 pure residual-noise grid is the current visual warning: increasing Gaussian residual noise moves the sign/covariance set, can make standard DW reject true `B0`, and leaves pure higher-cumulant robust DW truth-compatible but wide after invalid second-order anchors are dropped. | our-contribution | `manuscript/simulations/sign_dw_robust_noise_grid_figure.py --robust-mode pure`; `manuscript/simulations/sign_dw_pure_robust_noise_grid_figure.md`; `manuscript/figures/fig_sign_dw_pure_robust_noise_grid.png` | n/a |
