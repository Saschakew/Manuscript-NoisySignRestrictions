...
| `manuscript/simulations/m28_grid_story_validation.py` | Refreshed M28 validation pass for the superseded M0030 grid pair. | Historical for the robust row after M0034/M0035/M0036; rerun for the variance-ratio proposal after Figure 2/Figure 3 are rebuilt. |
...
12. M0034 supersedes the M37 pass judgment for the six-moment
    ...
    Sections 2-4; M40 conditionally passed the variance-ratio screen. M42-M45
    should now clean remaining math formatting, update Figure 2, add Figure 3,
    and rebuild evidence.
