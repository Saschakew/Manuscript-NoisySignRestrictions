...
| `manuscript/simulations/sign_dw_robust_nongaussianity_grid_figure.py` | Manuscript-local M0018 companion grid: fixes residual noise and varies structural-shock non-Gaussianity to show weak-moment widening. | Use beside the M0017 noise grid to show the limitation that robust-DW depends on informative higher moments. |
