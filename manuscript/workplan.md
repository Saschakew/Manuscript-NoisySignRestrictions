...
population figure, and an M0017 corrected B-plane grid figure with N-test
cutoffs. The evidence queue is now centered on population-grid
checks.
...
| M5. Evidence package | doing | M35 early Monte Carlo triage, M30 audit, M0016 exploratory figure, and M0017 corrected grid figure are complete; population-grid checks must come before polished figures or final Monte Carlo tables. |
...
6. Diagnostic interpretation review: verify that DW-versus-robust-DW
   ...
   error.
7. Evidence design: use the M35/M30 result and M0017 corrected grid figure as
