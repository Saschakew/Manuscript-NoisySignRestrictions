...
an M30 audit of that triage, an M0016 exploratory sign/DW/robust-DW
population figure, an M0017 corrected B-plane noise grid figure with N-test
cutoffs, and an M0018 non-Gaussianity companion grid. The evidence queue is
now centered on population-grid
checks.
...
| M5. Evidence package | doing | M35 early Monte Carlo triage, M30 audit, M0016 exploratory figure, M0017 corrected grid, and M0018 companion grid are complete; population-grid checks must come before polished figures or final Monte Carlo tables. |
...
6. Diagnostic interpretation review: verify that DW-versus-robust-DW
   ...
   error.
7. Evidence design: use the M35/M30 result and M0017/M0018 candidate grid
   figures as cautionary gates; run population grids before expanding
