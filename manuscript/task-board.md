...
| M26 | doing | 1 | figure | Design the intuitive noisy sign-set figure. | M0016 created a candidate sign/standard-DW/robust-DW noise figure from the KnowledgeVault visualization; decide whether to add the covariance-ellipse/sign-boundary geometry panel after M28 population-grid checks. |
