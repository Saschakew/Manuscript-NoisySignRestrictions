...
| M24 | todo | 1 | adversarial-review | Audit the robust DW higher-moment derivation. | Check cumulant-to-moment algebra, fourth-cumulant covariance subtractions, second-moment exclusion, normalization, local rank, global aliases, noise assumptions, and bias language. |
