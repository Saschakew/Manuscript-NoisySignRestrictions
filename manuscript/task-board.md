...
| M35 | todo | 1 | simulation | Run early J-test Monte Carlo triage. | Immediately after M25, run a small overview MC for standard-DW versus robust-DW J-test inversion behavior before investing in polished figures or a large replication package. |
