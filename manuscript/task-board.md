...
| M26 | doing | 1 | figure | Design the intuitive noisy sign-set figure. | M0017 created the requested 3-by-3 sign/DW/robust-DW B-plane noise grid; M0018 added the non-Gaussianity companion grid. Decide after M28/M29 whether these become the main evidence figures. |
