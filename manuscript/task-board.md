...
| M28 | todo | 1 | simulation | Build population-grid verification for standard DW and robust DW. | Use the M35 cautionary output to verify population zeros, pseudo-zeros, finite-stack aliases, and weak-moment widening before expanding finite-sample evidence. |
...
| M30 | todo | 1 | adversarial-review | Audit simulation code before trusting outputs. | Start with the M35 triage script: check DGP normalization, moment scaling, cumulant formulas, sign filters, grids, critical values, bootstrap/repetition logic, and interpretation. |
