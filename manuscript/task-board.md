...
| M28 | todo | 1 | simulation | Build population-grid verification for standard DW and robust DW. | Use the M30 audit findings: verify structural-rescaling exceptions, generic anisotropic-noise pseudo-zeros, robust-DW truth inclusion, finite-stack aliases, and weak-moment widening. |
