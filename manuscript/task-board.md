...
| M26 | doing | 1 | figure | Design the intuitive noisy sign-set figure. | M0019 corrected the requested 3-by-3 sign/DW/robust-DW B-plane noise grid and its non-Gaussianity companion so the robust rows use only higher cumulants and no second moments. Decide after M28/M29 whether these become the main evidence figures. |
