...
| How do I rebuild the active figures and M52 evidence from the replication folder? | Run `python manuscript\replication\run_all.py --stage all` for canonical outputs. Use `--stage evidence --quick` only for smoke outputs under `manuscript/replication/output/quick/`. | `manuscript/tasks/M33-replication-wrapper/outcome.md` | `manuscript/replication/README.md`; `manuscript/replication/run_all.py` |
