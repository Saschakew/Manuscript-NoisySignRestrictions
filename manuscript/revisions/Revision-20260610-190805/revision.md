...
E\{z_1(B)z_2(B)^3\}-3s_{22}(B)s_{12}(B) where the s depent on the B and the variance of the noise, correct? so instead of computing s as a sample average, cant we just tread the variances of the noise as a parameter we estimate and
